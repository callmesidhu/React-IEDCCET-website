...
function TeamCards() {
  ...
  return (
    <section className="w-full font-grotesk bg-white py-4 sm:py-6 md:py-8 lg:py-16 px-2 sm:px-4 relative">
      {/* left arrow */}
      <button
        onClick={prevSlide}
              ...
              {facultyData.map((faculty) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    {/* Description */}
                    <div className="bg-white p-2 sm:p-3 md:p-4 w-full text-center">
                      <h3 className="text-lg sm:text-xl font-bold text-black mb-1 line-clamp-1">
                        {faculty.name}
                      </h3>
                      <p className="text-sm sm:text-base text-black mb-1 sm:mb-2 line-clamp-1">
                        {faculty.designation}
                      </p>

                      <div className="flex flex-col items-center space-y-2">
                        <div className="flex items-center justify-center">
                          <FaEnvelope className="text-black mr-2 text-sm sm:text-base" />
                          <span className="text-black text-sm truncate max-w-[80px] sm:max-w-[120px]">
                            {faculty.email}
                          </span>
                        </div>
                        <div className="flex items-center justify-center">
                          <FaPhone className="text-black mr-1 text-sm sm:text-base" />
