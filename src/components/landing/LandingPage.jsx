...
function LandingPage() {
  ...
  return (
    <section className="w-full min-h-screen" style={{ backgroundColor: bgColor, color: textColor1 }}>
      ...
      <motion.div {...fadeIn}>
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-start max-w-[600px]">
            ...
            <p className="sm:text-lg text-sm sm:mt-10 mt-6" style={{color : textColor2}}>
