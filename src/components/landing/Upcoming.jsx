              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="bg-custom-blue p-2 sm:p-3 md:p-4 w-full text-center">
                    ...
                    <p className="text-sm sm:text-base text-white line-clamp-1">
                      {event.date}
                    </p>
                  </div>
                  <button className="mb-10 px-4 py-1 border-2 border-white text-white rounded-full text-lg hover:bg-blue-100 transition">
                  See Details &gt;
                </button>
                </div>
              </div>
